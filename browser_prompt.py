...
async def answer_generator_browser(
    ...
    if is_voice_mode:
        system_prompt += (
            ...
            "- Start your response directly with the core fact, a short topic hook, or a natural conversational transition (for example: 'Also,', 'Hmm,', 'Well,', 'So,').\n"
            "- CRITICAL RULE: If the immediately preceding assistant message started with a specific transition word (e.g., 'Also,'), you MUST NOT use that exact same word in your current response. You must rotate to a different word or start directly with the fact.\n"
            "- Do not repeat the same opening structure across turns.\n"
            "\n"
            ...
            "- You may use natural conversational transitions like 'Also,', 'Hmm,', 'Well,', 'So,' to soften the opening.\n"
            "- Remember to alternate them. Never reuse the exact same transition word from the previous turn.\n"
            ...
            "- Compare the first word of this answer with the opening of the last assistant message in `conversation_history`. If you are reusing the exact same transition word (e.g., 'Also,', 'Hmm,', 'Well,', 'So,'), rewrite the opening to use a different one or none at all.\n"
