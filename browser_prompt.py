...
async def answer_generator_browser(
    ...
    if is_voice_mode:
        system_prompt += (
            ...
            "- Start your response directly with the core fact, a short topic hook, or a natural conversational transition.\n"
            "- Do not repeat the same opening structure or the same transition words across turns.\n"
            "- If the last assistant reply began with a conversational transition, start this answer differently: jump straight to the fact or use a brief topic hook.\n"
            "\n"
            ...
            "- You may use natural conversational transitions to soften the opening, but do not overuse them. Use them at most once per answer, and never if recent assistant messages already used them.\n"
            ...
            "in `conversation_history`. If they match or rhyme (same structure or same transition word), rewrite the opening.\n"
